  ...
  return (
    <header className="mb-6 flex flex-wrap items-start justify-between gap-4">
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div><h1 className="text-2xl font-bold leading-tight text-[color:var(--foreground)]">{title}</h1><p className="mt-1 max-w-3xl text-sm leading-6 text-[color:var(--muted-foreground)]">{subtitle}</p></div>
      </div>
      {action}
    </header>
  );

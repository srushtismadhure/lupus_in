      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64">
            <DropdownMenuLabel><span className="block font-semibold">{user?.displayName}</span><span className="block text-xs font-normal text-[color:var(--muted-foreground)]">Patient portal session</span></DropdownMenuLabel>
